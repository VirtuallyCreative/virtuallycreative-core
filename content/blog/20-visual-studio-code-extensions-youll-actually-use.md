---
title: 20 Visual Studio Code Extensions You'll Actually Use
subtitle: A interesting tale about function of design
excerpt: >-
  These are helpful for any primarily front-end developer who wants to get the most out of using Visual Studio Code.
date: '2019-02-25'
thumb_image: images/vscode_screencap.jpeg
thumb_image_alt: Close up of HTML code in an editor.
image: images/vscode_screencap.jpeg
image_alt: Close up of HTML code in an editor.
seo:
  title: 20 Visual Studio Code Extensions You'll Actually Use
  description: >-
    These are helpful for any primarily front-end developer who wants to get the most out of using Visual Studio Code.
  extra:
    - name: 'og:type'
      ...
      keyName: property
    - name: 'og:title'
      value: 20 Visual Studio Code Extensions You'll Actually Use
      keyName: property
    - name: 'og:description'
      value: >-
        These are helpful for any primarily front-end developer who wants to get the most out of using Visual Studio Code.
      keyName: property
    - name: 'og:image'
      value: images/vscode_screencap.jpeg
      keyName: property
      relativeUrl: true
    - name: 'twitter:card'
...
This post was originally written on, [dev.to](https://dev.to/vip3rousmango/vs-code-extensions-youll-actually-use-46gp)
