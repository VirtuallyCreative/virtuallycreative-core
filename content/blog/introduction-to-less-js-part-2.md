...
#header { border-radius: 5px; /\* This is 5px because that's the default @radius value we set \*/ -webkit-border-radius: 5px; /\* This is 5px because that's the default @radius value we set \*/ -moz-border-radius: 5px; /\* This is 5px because that's the default @radius value we set \*/ } #footer { background-color: #000000; border-radius: 10px; /\* This is 10px because we passed a value of 10px \*/ -webkit-border-radius: 10px; /\* This is 10px because we passed a value of 10px \*/ -moz-border-radius: 10px; /\* This is 10px because we passed a value of 10px \*/ } \[/css\]
